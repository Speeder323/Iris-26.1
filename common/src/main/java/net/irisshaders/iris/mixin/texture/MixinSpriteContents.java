...
public class MixinSpriteContents implements SpriteContentsExtension {
	...
	private NativeImage[] iris$redirectMipmapGeneration(final Identifier name, final NativeImage[] currentMips, final int newMipLevel, MipmapStrategy mipmapStrategy, final float alphaCutoffBias, Operation<NativeImage[]> original) {
		...
		return original.call(name, currentMips, newMipLevel, mipmapStrategy, alphaCutoffBias);
	}
}
